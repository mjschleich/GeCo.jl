...
@GROUP(p_all, s for s in propertynames(X) if contains(string(s), "city"))
@GROUP(p_all, s for s in propertynames(X) if contains(string(s), "state_id"))
@GROUP(p_all, s for s in propertynames(X) if contains(string(s), "category"))

@PLAF(p_all, cf.latitude == x.latitude)
@PLAF(p_all, cf.longitude == x.longitude)
@PLAF(p_all, cf.year_joined == x.year_joined)

@PLAF(p_all, cf.reviewcount >= x.reviewcount)
@PLAF(p_all, cf.review_count >= x.review_count)
@PLAF(p_all, cf.compliement_hot >= x.compliement_hot)
@PLAF(p_all, cf.compliment_more >= x.compliment_more)
@PLAF(p_all, cf.compliment_profile >= x.compliment_profile)
@PLAF(p_all, cf.compliment_cute >= x.compliment_cute)
@PLAF(p_all, cf.compliment_list >= x.compliment_list)
@PLAF(p_all, cf.compliment_note >= x.compliment_note)
@PLAF(p_all, cf.compliment_plain >= x.compliment_plain)
@PLAF(p_all, cf.compliment_cool >= x.compliment_cool)
@PLAF(p_all, cf.compliment_funny >= x.compliment_funny)
@PLAF(p_all, cf.compliment_writer >= x.compliment_writer)
@PLAF(p_all, cf.compliment_photos >= x.compliment_photos)

@PLAF(p_all, cf.city__1 == x.city__1 &&
...
@PLAF(p_all, if cf.reviewcount > x.reviewcount;  cf.is_open .>= x.is_open end)
@PLAF(p_all, if cf.cool > x.cool; cf.compliment_cool > x.compliment_cool end)
@PLAF(p_all, if cf.funny > x.funny; cf.compliment_funny > x.compliment_funny end)
...
p_no_increase = PLAFProgram()

@GROUP(p_no_increase, s for s in propertynames(X) if contains(string(s), "city"))
@GROUP(p_no_increase, s for s in propertynames(X) if contains(string(s), "state_id"))
@GROUP(p_no_increase, s for s in propertynames(X) if contains(string(s), "category"))

@PLAF(p_no_increase, cf.latitude == x.latitude)
@PLAF(p_no_increase, cf.longitude == x.longitude)
@PLAF(p_no_increase, cf.year_joined == x.year_joined)

@PLAF(p_no_increase, cf.city__1 == x.city__1 &&
    cf.city__6 == x.city__6 &&
    cf.city__9 == x.city__9 &&
    cf.city__14 == x.city__14 &&
    cf.city__15 == x.city__15 &&
